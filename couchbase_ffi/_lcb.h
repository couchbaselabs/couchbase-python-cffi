...
typedef enum {
    LCB_SSL_ENABLED = 0x01,
    LCB_SSL_NOVERIFY = 0x02
} lcb_SSLOPTS;
typedef enum {
...
typedef enum {
    LCB_RETRY_CMDS_NONE = 0x00,
    LCB_RETRY_CMDS_GET = 0x01,
    LCB_RETRY_CMDS_SAFE = 0x03,
    LCB_RETRY_CMDS_ALL = 0x03
} lcb_RETRYCMDOPTS;
typedef enum {
...
typedef enum {
    ...
    LCB_COMPRESS_IN = 0x01,
    LCB_COMPRESS_OUT = 0x02,
    LCB_COMPRESS_INOUT = 0x03,
    LCB_COMPRESS_FORCE = 0x04
} lcb_COMPRESSOPTS;
